            ...
            if method == "pruning":
                ...
                with torch.enable_grad():
                    ...
                    with precision_context(model, torch.float32):
                        hes = hessian(model, nn.CrossEntropyLoss(), dataloader=dataloader, cuda=True)
...
if __name__ == '__main__':
    ...
    if (args.sparsity or args.prunen) and not args.gmp:
        ...
        sensitivity = get_sensitivity(model, dataloader, dev=torch.device('cuda'), sparsity_way=args.sparsity_way,args=args)
